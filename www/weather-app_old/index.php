<?php
    ...
    function getWeatherForecast($mesto) {
        ...
        $json = file_get_contents("https://api.openweathermap.org/data/2.5/weather?q=".$mesto."&APPID=347daf3f92c0d8652b70ee139b366eb1&units=metric");
        ...
        $json = file_get_contents("https://api.openweathermap.org/data/2.5/forecast?q=".$mesto."&APPID=347daf3f92c0d8652b70ee139b366eb1&units=metric");
